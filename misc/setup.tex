...
%
% 2. A line on the title page, white on white inside a zero-size box, so it prints
%    nothing and shifts no layout. It is NOT hidden from software: copy and paste,
%    screen readers and text extraction all return it. main.tex calls it on the
%    verso of the title page, the colophon position, which stays visually blank.
%    Empty the macro body below to drop the line.
